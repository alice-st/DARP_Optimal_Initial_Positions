class GridPathsToNED:
    ...
    def __init__(self, optimization, droneNo, subNodes, rotate):
    ...
    def init_posGRIDToNED(self):
        # init_pos = self.optimization.best_trial.darp_instance.initial_positions
        init_pos_NED = []
        for k in range(self.droneNo):
            xInit = 2 * self.optimization.best_trial.darp_instance.initial_positions[k][0]
            yInit = 2 * self.optimization.best_trial.darp_instance.initial_positions[k][1]
    ...
    def getWaypointsNED(self):
        ...
        TypesOfLines = self.optimization.best_trial.TypesOfLines
